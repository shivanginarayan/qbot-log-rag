...
All navigation and localization testing uses the shared configuration:
...
uses the shared ROS domain ID, saves the matching labels JSON, builds if necessary,
